...
import { Box, VStack, HStack, Text, Link, Icon, Img, useColorMode } from '@chakra-ui/react';
...
export const Footer = () => {
  ...
  return (
    <Box bg={colorMode === "dark" ? "brand.light" : "brand.dark"} color="white" py={8} px={4}>
      <VStack spacing={4} align="flex-start" maxW="container.lg" mx="auto">
        ...
        <Box pt={4}>
          <Text fontWeight="bold" mb={2}>Seguinos</Text>
          <HStack spacing={4} color={'primary.default'}>
            <Link><Icon as={BsTwitterX} boxSize={6} /></Link>
